package io.github.yak33.generator.util;
...
import io.github.yak33.common.mybatis.enums.DataBaseType;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("io.github.yak33.common.translation.annotation.Translation");
                importList.add("io.github.yak33.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
